...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // ================================================================
  //  2–4. SHARED SLIDER LOGIC (used by Featured, Testimonials, Events)
  // ================================================================
  function initSlider({
    sliderId,
    slideSelector,
...
/* ================================================================
   LOAD MORE PRODUCTS (Optional – shows more products on click)
   ================================================================ */
...
if (loadMoreBtn && hiddenCards.length > 0) {
  ...
  loadMoreBtn.addEventListener("click", () => {
    hiddenCards.forEach((card) => {
      ...
      card.style.display = "flex"; // ensure it becomes visible
    });
